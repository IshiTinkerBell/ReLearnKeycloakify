import{r as k,j as t}from"./index-CUfmgbRF.js";import{u as O,g as N}from"./KcPage-DecFJJ35.js";import{a as y}from"./assert-vnZbOQIH.js";import{w as S}from"./waitForElementMountedOnDom-qpCjLZnq.js";import"./logo-kaIfqRYZ.js";y();y();function B(a){const{authButtonId:e,kcContext:n,i18n:i}=a,{url:l,challenge:r,userid:s,username:o,signatureAlgorithms:d,rpEntityName:m,rpId:c,attestationConveyancePreference:g,authenticatorAttachment:u,requireResidentKey:b,userVerificationRequirement:f,createTimeout:x,excludeCredentialIds:j}=n,{msgStr:p,isFetchingTranslations:h}=i,{insertScriptTags:C}=O({componentOrHookName:"LoginRecoveryAuthnCodeConfig",scriptTags:[{type:"module",textContent:()=>`
